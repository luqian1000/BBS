...
<div class="search-area-wrapper">
	<div class="search-area container">
		...
		<%--模糊搜索--%>
		<form id="search-form" class="search-form clearfix" method="post" action="${pageContext.request.contextPath}/control/select/fuzzy" >
			<input class="search-term required" type="text" id="s" name="essayname" placeholder="Type your search terms here" title="* Please enter a search term!" />
